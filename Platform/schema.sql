...
CREATE TABLE IF NOT EXISTS `caselist` (
  ...
  `mock_status` int(2) DEFAULT 0 COMMENT '是否已经录制接口',
  `status` int(2) DEFAULT 0 COMMENT '测试结果',
  `reset_status` int(2) DEFAULT 0 COMMENT '重置标志',
...
insert into base_user values(2, 'yuefan.huang', '123456', '黄岳樊', 'QDD', 1);
insert into base_user values(3, 'xinpan.li', '123456', '李新盼', 'SOS', 1);
